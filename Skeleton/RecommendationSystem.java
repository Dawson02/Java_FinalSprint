    ...
    public List<String> generateRecommendations(HealthData healthData) {
        ...
        if (heartRate < MIN_HEART_RATE) {
            recommendations.add("Your heart rate is lower than the recommended range. " +
                ...
                recommendations.add("Your heart rate is higher than the recommended range." + "Consider decreasing your physical activity to lower your heart rate or consult your doctor.");
        }
